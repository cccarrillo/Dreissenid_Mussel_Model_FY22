...
;  "nls/Lake_drawdown_infest.nls"     ;calculates the lake drawdown management option
  "nls/CC_Lake_Drawdown.nls"         ;carra new file for calculating the impact of lake drawdown
]
...
to go                                         ;beginning of go procedure
  ...
  ;if manage? [lake-drawdown-infesting]                           ;calculates decrease from lake drawdown
